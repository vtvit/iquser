...
LOGS = logging.getLogger("بـۆتی زیرەك")
    ...
    if session:
        ...
        if session.startswith(CURRENT_VERSION):
            if len(session.strip()) != 353:
                logger.exception("ببوورە .. کۆدی تێرمۆکس نەدۆزرایەوە، بۆیە پرۆسەکە وەستا")
                sys.exit()
        ...
        # Pyrogram Code
            ...
            if _exit:
                sys.exit()
    logger.exception("ببوورە ..کۆدی  تێرموکس نەدۆزرایەوە، بۆیە پرۆسەکە وەستا")
    if _exit:
        sys.exit()
